...
def sample_pages(pdf_path: str, name: str, qa_root: str, n: int = 20,
                 seed: int = 42, dpi: int = 140) -> dict:
    ...
    with open(os.path.join(qa, "mapping.json"), "w") as f:
        json.dump(mapping, f, indent=1)
    return {"qa_dir": qa, "sample_pdf": sample_pdf, "pages": pages,
            "range": (lo, hi), "page_count": d.page_count, "seed": seed}
